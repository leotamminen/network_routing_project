...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Router router1 = new Router("router1","localhost", 5000);
        Router router2 = new Router("router2", "localhost", 5001);
        Router router3 = new Router("router3","localhost", 5002);
        Router router4 = new Router("router4", "localhost", 5003);
        ...
        router1.addRoute("router1", "router2");  // Next hop to router4
        router2.addRoute("router2", "router3");
        router3.addRoute("router3", "router4");
        ...
        router1.sendPacket("router4", data);  // Route the packet to Router4
    }
}
